        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('teacher.detail', ['user' => $user->id]) }}"
                        class="text-blue-600 hover:text-blue-900">
                        ← Kembali ke Detail Guru
                    </a>
                </div>
                <form action="{{ route('admin.teacher.schedules.update', ['user' => $user, 'schedule' => $schedule]) }}"
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit"
                            class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Simpan
                            Perubahan</button>
                    </div>
                </form>
            </div>
